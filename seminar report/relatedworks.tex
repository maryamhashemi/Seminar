  ...
  نمونه‌هایی از معماری دو جریان هستند که از این دو مدل می‌توان برای مسئله پرسش و پاسخ تصویری استفاده کرد. پس در ادامه این بخش، جزئیات این دو شبکه را بررسی خواهیم کرد.
	...
	\begin{table}
		...
		\begin{tabularx}{\textwidth}{|C|C|C|C|C|}
			...
			\hline
			\textbf{\cite{li2020oscar}\lr{OSCAR}}& تک جریان & کلمات جمله + \lr{ROI}های تصویر  & \lr{Conceptual Captions} & \lr{text-based MLM + visual-based MLM + Image-Text Matching + Word-Region Alignment}\\
			\hline
			\textbf{\cite{zhou2020unified}\lr{VLP}}& تک جریان & - & - & -\\
			\hline \hline
			\textbf{\cite{lu2019vilbert}\lr{ViL-BERT}}& دو جریان & - & - & -\\
			\hline
			\textbf{\cite{tan2019lxmert}\lr{LXMERT}}& دو جریان & - & - & -\\
			\hline		
		\end{tabularx}
	\end{table}
